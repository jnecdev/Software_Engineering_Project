						...
						<div class="section">
							...
							?>
								<form action="" name="student" method="POST">
									...
									<a href="totalstudentdeletion.php?<?php Print "username=$studnum&lname=$lname&fname=$fname&mname=$mname"?>" onClick="succ()">Delete Entire Record</a>
									<br/><a href="annual.php">Back to List</a>
								</form>
									<?php
