			...
			<div>
				<div>
					<div class="register">
						...
						<form action="admineditinfo.php" method="POST"/>
							<div>
								<table>
								<?php
									//include('config.php);
								...
								if($_SERVER['REQUEST_METHOD'] == 'POST') { //if the register was clicked
									...
									if(empty($password)){
									$user_input = mysql_query("UPDATE admin SET phone_number='$pnumber', cell_number='$cnumber', fname='$fname', mname='$mname', lname='$lname', email='$email' WHERE username='$username'");
									...
									while($row = mysql_fetch_assoc($query)){
										...
										if($pass != $password){
											...
											mysql_query("UPDATE admin SET password='$npassword' WHERE username='$username'");
											echo("<p>Succesfully Edited!</p>");
									}
									}							
								}
?>
									...
									?>
									<tr>
										<td><a href="adminprofile.php"><label for="name"><span>B</span>ack to Profile</label></td>
									</tr>		
									<tr>
										<td><label for="name"><span>U</span>sername:</label></td>
										<td><label for="name"><span><?php Print"$username"?></label></td>
									</tr>
									<tr>
