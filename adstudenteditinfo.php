			...
			<div>
				...
				<div>
					...
					<div class="register">
						...
						<form action="adstudenteditinfo.php" method="POST"/>
							...
							<div>
								...
								if($_SERVER['REQUEST_METHOD'] == 'POST') { 
									...
									$user_input = mysql_query("UPDATE $user2 SET address='$address', zip_code='$zip', phone_number='$pnumber', cell_number='$cnumber', fname='$fname', mname='$mname', lname='$lname', email='$email', enroll_date='$enroll', nationality='$nationality', religion='$religion' WHERE username='$student'");
