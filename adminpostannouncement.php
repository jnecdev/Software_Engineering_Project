...
<head>
...

	{
		...
		document.location.href="adportalcommunity.php";
				...
				<div>
					...
					<div>
						...
						<div class="section">
							...
							<h2>Post a School Announcement</h2>

							<form action="postan.php" method="POST">

								<textarea cols="100" rows="10" name="message"></textarea><br/>

								<input type="button" onclick="myFunction2()" value="Cancel" >
