			...
			<div>
				...
				<div>
					...
					<div class="register">
						...
						<form action="portalindex.php" method="POST"/>
							...
							<div>
								...
								if($_SERVER['REQUEST_METHOD'] == 'POST') { 
									...
									$user_input = mysql_query("UPDATE $user2 SET address='$address', zip_code='$zip', phone_number='$pnumber', cell_number='$cnumber', fname='$fname', mname='$mname', lname='$lname', email='$email', enroll_date='$enroll', cperson='$cperson', nationality='$nationality', religion='$religion', emergency='$emergency' WHERE username='$student'");

									Print "<p>Succesfully Edited!</p>";
...
?>
									...
									<tr>
										...
										<td><a href="adportalindex.php"><label for="name"><span>B</span>ack to list</label></td>
									...
									<tr>
										...
										<td><textarea name="address" cols="40" rows="5"><?php Print "$address"?></textarea></td>
									...
									<tr>
										...
										<td><input type="date" name="enroll" value="<?php Print "$enroll"?>"/></td>

									</tr>

									<tr>

										<td><label for="mother"><span>C</span>ontact Person:</label></td>

										<td><input type="text" name="cperson" value="<?php Print "$cperson"?>"/></td>

									</tr>

									<tr>

										<td><label for="mother"><span>C</span>ontact Person's Number:</label></td>

										<td><input type="text" name="emergency" value="<?php Print "$emergency"?>"/></td>
									...
									<tr>
										...
										<td><input type="text" name="nationality" value="<?php Print "$nationality"?>"/></td>
									...
									<tr>
										...
										<td><input type="text" name="religion" value="<?php Print "$religion"?>"/></td>
